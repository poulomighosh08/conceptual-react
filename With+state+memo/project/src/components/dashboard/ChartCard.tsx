...
const ChartCard: React.FC<ChartCardProps> = ({ 
  ...
  const { state } = useFilter(); // ✅ access global filter context
    ...
    <div className={`${width} p-2`}>
      <div className="bg-white border border-gray-200 rounded-md p-4 h-full">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-sm font-medium text-gray-700">{data.title} — <span className="text-gray-400">{timeRange}</span></h3>
          {dropdown && (
